-- ===========================================================================
-- Phase 5 — reseller pricing on invoices (same rule as orders): the customer's type
-- defaults each line to reseller_price_pkr (trade/workshop) or retail, with a per-line
-- override. An invoice prefilled from an order carries the order's snapshotted prices
-- (the tier it used) via the dialog; a standalone invoice tier-prices here.
-- ===========================================================================
